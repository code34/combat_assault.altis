	...
	*/
	...
	CLASS("OO_CONVOY")
		...
		PUBLIC FUNCTION("", "startConvoy") {	
			...
			["remoteSpawn", ["BME_netcode_client_wcconvoystart", true, "client"]] call server_bme;
			...
			if(_rate > 99) then {
				...
				["remoteSpawn", ["BME_netcode_client_wcconvoy", true, "client"]] call server_bme;
				...
				["remoteSpawn", ["BME_netcode_client_wcconvoy", false, "client"]] call server_bme;
